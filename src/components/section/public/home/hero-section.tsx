        ...
        <Box className="grid lg:grid-cols-[3fr_1fr] grid-rows-1 w-full ">
          <Box className="flex justify-center items-center flex-col">
            <Box className=" w-full lg:max-w-180 p-2 my-2 h-full ">
              <Label className="text-5xl lg:text-8xl font-bold text-center lg:text-start">
                Fresh Foods <span className="font-light">with</span> Great taste
              </Label>
              <Label className="font-light text-justify text-lg">
              ...
              <Button
                className="flex justify-center items-center border w-full gap-2 my-2 lg:h-auto lg:w-auto "
                variant="glass"
              >
                <IconPhone size={40} />
